...
<section id="profile" class="bg-purple-200 py-8">

        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">

            <header id="profile-info" class="w-full top-0 px-6 py-1">
            <div class="flex-shrink-0 h-60 w-60">
            <img class="h-40 w-40 rounded-full border-purple-900 border-2" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=4&amp;w=256&amp;h=256&amp;q=60" alt="">
            </div>
            </header>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#" class="relative">
                    ...
                    <div class="hover-layer bg-yellow-300 bg-opacity-50 absolute h-full w-full top-0 left-0 flex justify-center items-center">
                        <i class="fas fa-heart text-purple-300 text-3xl"></i><span class="px-3 text-xl font-semibold">125</span>
                        <i class="fas fa-comments text-purple-300 text-3xl"></i><span class="px-3 text-xl font-semibold">21</span>
                        <i class="far fa-bookmark text-purple-300 text-3xl"></i>
                    </div>
                </a>
            </div>
